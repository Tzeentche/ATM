...
public class FillUserAcc {
    ...
    public void fillTheBill() {
        ...
        try {
            ...
            System.out.println("ConnectedFilling");
//            co.close();
//            System.out.println("Close connection");

        } catch (Exception e) {
            System.out.println(e.getMessage());
            System.out.println("Filling registration crashed!");
        }
    ...
    public void filler(int entrance, int summ) {
...
//                        rs4.close();
                        ...
                        System.out.println("Your balance is to big for our system. Please, keep calm and carry on!");
                        questing();
                    }
                    ...
                    System.out.println("Filling crashed!");
                }
